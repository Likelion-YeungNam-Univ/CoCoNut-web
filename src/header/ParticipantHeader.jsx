  ...
  return (
    <div className="w-full h-[60px] flex items-center px-[120px] bg-white border-b border-gray-200 font-pretendard">
      ...
      <div className="flex-1 flex justify-end gap-8">
        <button
          onClick={() => navigate("/participant-myproject")}
                ...
                <>
                  ...
                  <ul className="space-y-2 text-[#212121] font-normal">
                    <li className="p-1 cursor-pointer hover:bg-gray-100 rounded">
                      <Link to="/participant-mypage">내 프로필</Link>
                    </li>
                    <li className="p-1 cursor-pointer hover:bg-gray-100 rounded">
                      <Link to="/participant-mypage?tab=terms">
                        약관 및 정책
                      </Link>
                    </li>
                    <li className="p-1 cursor-pointer hover:bg-gray-100 rounded">
                      <Link to="/participant-mypage?tab=customer-service">
                        고객센터
                      </Link>
                    </li>
                    <li className="p-1 cursor-pointer hover:bg-gray-100 rounded">
