...
const Signup = () => {
  ...
  const checkEmailDuplicate = async () => {
    ...
    try {
      ...
      if (!emailRegex.test(email)) {
        setEmailMessage(
          "이메일 형식에 맞춰 입력해 주세요.(예: abcd@gmail.com)"
        );
        return;
      }
  ...
  return (
    <div className="bg-[#F3F3F3] flex flex-col items-center font-pretendard">
      <span className="font-semibold text-[32px] mt-[40px]">회원가입</span>
      <div className="flex justify-between w-[504px] mt-[30px] mb-[20px]">
        {stepBox(1, "회원 유형 선택")}
        {stepBox(2, "회원 정보 입력")}
        {stepBox(3, "회원가입 완료")}
      </div>
      ...
      {currentStep === 1 && (
        <div className="border w-[504px] h-[480px] flex flex-col items-center text-center rounded-[12px] border-[#FFFFFF] bg-[#FFFFFF]">
          <span className="text-[20px] font-semibold text-[#212121] mt-[40px]">
            회원 유형을 선택해 주세요.
          </span>
          <span className="text-[#A3A3A3] text-[14px]">
            유형에 따라 서비스를 다양하게 이용할 수 있어요.
          </span>

          <div className="flex flex-row gap-5 mt-[40px]">
            <div
              onClick={() => setRole("참가자")}
              role="button"
            ...
            >
              <img
                className="w-[80px] h-[80px] mt-[32px]"
                src={mclogo}
                alt="participantlogo"
              />
              <button
                className="mt-[12px] font-semibold text-[20px] text-[#212121] "
                type="button"
              >
                참가자
              </button>
            ...
            >
              ...
              />
              <button
                className="font-semibold text-[20px] mt-[12px] text-[#212121]"
                type="button"
              >
                소상공인
              </button>
          ...
          <button
            ...
            disabled={!role}
            className={`w-[180px] h-[45px] border rounded-[8px] text-white mt-8 cursor-pointer
      ...
      {currentStep === 2 && (
        <div className="border w-[504px] h-[654px] rounded-[12px] border-[#FFFFFF] bg-[#FFFFFF] font-pretendard mb-[68px]">
          <div className="flex flex-col my-[18px] mx-[36px]">
            <form className="flex flex-col gap-[8px]" onSubmit={signUpHandler}>
              <div className="flex flex-col gap-[20px]">
                <div className="flex flex-col gap-[8px]">
                  <label className="text-[14px] text-[#212121] flex gap-[2px] mt-[12px]">
                    아이디<span className="text-[14px] text-[#2FD8F6]">*</span>
                  </label>
                  <div>
                    <div className="flex gap-[12px] items-center">
                      <input
                        className="pt-[15px] pr-[16px] pb-[15px] pl-[16px] text-[14px] border rounded-[6px] border-[#F3F3F3] w-[321px] h-[48px] focus:outline-none placeholder-[#C3C3C3]"
                        value={email}
                        onChange={(e) => {
                      ...
                      <button
                        ...
                        className={`w-[91px] h-[48px] border rounded-[6px] text-[14px]
                      ${
                        !email || checkingEmail
                    ...
                    <div className="h-[1px] mb-4 ml-1.5">
                      {emailMessage && (
                        <span
                          className={`text-[12px] ${
                            emailMessage.includes("사용 가능한")
                              ? "text-[#2CCC41]"
                              : "text-[#EE4343]"
                          }`}
                        >
                ...
                <div className="flex flex-col gap-[8px]">
                  ...
                  <div className="flex flex-col">
                    <div className="flex gap-[12px] items-center">
                      <input
                        className="pt-[15px] pr-[16px] pb-[15px] pl-[16px] border rounded-[6px] text-[14px] border-[#F3F3F3] w-[321px] h-[48px] focus:outline-none placeholder-[#C3C3C3]"
                        value={nickname}
                        onChange={(e) => {
          ...
          ${
            !nickname || checkingNickname
              ...
              : "bg-[#4C4C4C] text-white hover:opacity-90 text-[14px]"
                    ...
                    <div className="mt-[1px] h-[1px] mb-4 ml-1.5">
                      {nicknameMessage && (
                        <span
                          className={`text-[12px]  ${
                ...
                <div className="flex flex-col gap-[8px]">
                  <label className="text-[14px] flex gap-[2px]">
                    이름<span className="text-[14px] text-[#2FD8F6]">*</span>
                  </label>
                  <input
                    className="pt-[15px] pr-[16px] pb-[15px] pl-[16px] text-[14px] border rounded-[6px] border-[#F3F3F3] w-[424px] h-[48px] focus:outline-none placeholder-[#C3C3C3]"
                    value={name}
                ...
                <div className="flex flex-col gap-[8px]">
                  <label className="text-[14px] flex gap-[2px]">
                    비밀번호
                    <span className="text-[14px] text-[#2FD8F6]">*</span>
                  </label>
                  ...
                  <div className="flex flex-col">
                    <div className="relative w-[424px]">
                      <input
                        className="text-[14px] pt-[15px] pr-[40px] pb-[15px] pl-[16px] border rounded-[6px] border-[#F3F3F3] w-full h-[48px] focus:outline-none placeholder-[#C3C3C3]"
                        value={password}
                        onChange={(e) => {
                    ...
                    {/* 메시지 영역: mt 값으로 간격 조절 */}
                    <div className="mt-[1px] h-[1px] mb-3 ml-1.5">
                      {passwordMessage && (
                        <span className="text-[12px] text-[#EE4343]">
                          {passwordMessage}
                        </span>
                      )}
                    </div>
                ...
                <div className="flex flex-col gap-[14px]">
                  <div className="flex flex-row items-center gap-[8px] ">
                    ...
                    <div className="flex gap-[191px]">
                      ...
                      <button
                        type="button"
                        className="text-[12px] underline text-[#A3A3A3] hover:text-[#828282] cursor-pointer"
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className={`mt-[24px] w-[180px] h-[45px] border rounded-[8px] pt-[12px] pr-[20px] pb-[12px] pl-[20px] border-[#E1E1E1] text-[16px] text-white cursor-pointer 
                    ${
                      termsAgreed1 && termsAgreed2 && isPasswordValid
      ...
      {currentStep === 3 && (
        <div className="flex flex-col font-pretendard items-center border border-white rounded-[12px] bg-white w-[504px] h-[340px]">
          ...
          <span className="mt-[20px] font-semibold text-[24px]">
            회원가입이 완료되었습니다.
          </span>
          <span className="mt-[8px] text-[#A3A3A3] text-[14px]">
            로그인 후 브릿지의 서비스를 이용하실 수 있습니다.
          </span>
          <Link
            className="mt-[40px] border border-[#2FD8F6] text-white bg-[#2FD8F6] rounded-[8px] py-[12px] px-[40px] hover:bg-[#2AC2DD] cursor-pointer"
            to="/signin"
          >
            로그인하러 가기
          </Link>
