  ...
  return (
    ...
    <div className='border p-2 border-t-[#FFFFFF] border-b-[#F3F3F3]'>
       <div className='flex flex-row justify-between mt-3'>
        ...
        <Link className='border bg-[#4C4C4C] text-[#FFFFFF] rounded-xl w-24 h-10 pl-5 pt-2' to='/sign-up'>회원가입</Link>
        </div>
    </div>
    </div>
    ...
    <div className='flex gap-3 mt-4'>
        <Link className='border border-[#2FD8F6] bg-[#EAFBFE] rounded-xl p-3 w-32 text-[#2FD8F6]' to="/signin">공모전 참여하기</Link>
        <Link className='border rounded-xl bg-[#2FD8F6] p-3 pl-7 w-36 text-[#FFFFFF]' to="/signin">도움 요청하기</Link>
    </div>
